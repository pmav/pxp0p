package eu.pmav.pxp0p.frameconfiguration.impl.examples.circle;
...
public class Circle01ConfigurationGenerator extends FrameConfigurationGenerator
{
    private final String ID = "Circle_01_base";
