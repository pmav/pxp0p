package eu.pmav.pxp0p.frameconfiguration.impl.examples.semicircle;
...
public class SemiCircle01ConfigurationGenerator extends FrameConfigurationGenerator
{
    private final String ID = "SemiCircle_01_base";
    ...
    public List<FrameConfiguration> generateConfigurations() throws Exception {
        ...
        // Layout
        fc = applyParameter(fc, List.of(1), (c, v) -> c.setObjectColumns((int) v));
        ...
        fc = applyParameter(fc, List.of(new int[]{colorWhite}), (c, v) -> c.addColorsForm(FormType.SEMICIRCLE, (int[]) v));
