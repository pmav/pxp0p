package eu.pmav.pxp0p.frameconfiguration.impl.square;
...
public class Square01ConfigurationGenerator extends FrameConfigurationGenerator
{
    private final String ID = "Square_01_base";
