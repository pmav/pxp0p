package eu.pmav.pxp0p.frameconfiguration.impl.examples.triangle;
...
public class Triangle09ConfigurationGenerator extends FrameConfigurationGenerator
{
    private final String ID = "Triangle_09_alpha";
    ...
    public List<FrameConfiguration> generateConfigurations() throws Exception {
        ...
        fc = applyParameter(fc, List.of(new int[]{colorBlue}), (c, v) -> c.setColorsCutTriangle((int[]) v));
